...
type Client interface {
	...
	CreateCheckpoint(ctx context.Context, containerID string, checkpointDir string, preDump bool, parentPath string, exit bool, shellJob bool, tcpConnect bool, pageServer string) error
}
